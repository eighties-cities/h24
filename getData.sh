...
mkdir data
cd data
# WARNING : this step does not work yet!!! download it using your browser!
curl -A "Mozilla" -O https://wxs-telechargement.ign.fr/1yhlj2ehpqf3q6dt6a2y7b64/telechargement/inspire/CONTOURS-IRIS-FRANCE-2014-01-01$CONTOURS-IRIS_2-0__SHP_LAMB93_FXX_2014-01-01/file/CONTOURS-IRIS_2-0__SHP_LAMB93_FXX_2014-01-01.7z
...
7z x CONTOURS-IRIS_2-0__SHP_LAMB93_FXX_2014-01-01.7z
unzip ECP1KM_09_MET.zip
unzip infra-population-2012.zip
unzip infra-formation-2012.zip

\rm CONTOURS-IRIS_2-0__SHP_LAMB93_FXX_2014-01-01.7z
